...
void myGraphParabola(){
    ...
    auto gausppar = new TF1("gausppar",the_gausppar,5.0,5.6,6);// El 6 es el número de parámetros

    format_line(gausppar,kBlue,0);
    gausppar->SetParNames("Norm","Mean","Sigma","a","b","c"); // Nombramos los parámetros

    gausppar->SetParameter(0,1e2);
    gausppar->SetParameter(1,5.3);
