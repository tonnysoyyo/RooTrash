...
int GrapLinearFit(){
  ...
  auto f = new TF1("Linear law","cheb2",.5,10.5); // Aquí usamos un polinomio de grado 2 de Chebyshev (estos polinomios son mejores que los normales porque dichos polinomios son ortonormales)
  ...
  graph.Print(); // Aquí estoy imprimiendo la información de los datos que leí en el .txt
